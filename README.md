# Warden — Self-Sovereign Identity Attestation Vault

Warden is a decentralized self-sovereign identity (SSI) credential vault built on the Stellar Soroban network. It enables secure issuing, storing, and selective disclosure verification of identity attestations.

---

## 1. Project Description

Warden provides an end-to-end framework allowing subjects to maintain ownership over their identity documents (such as passports, academic degrees, and driver's licenses) while enabling third-party verifiers to validate assertions (such as age or document validity) without needing access to the raw values. 
...
To build, test, and run the Warden monorepo locally, follow these steps:
...
Warden uses a multi-contract architecture where attestations, user metadata, and access permissions are segregated into specialized modules.
...
Inter-contract calls in Soroban are executed using `env.invoke_contract`. In Warden, verification represents a chained **two-hop execution sequence**:
...
- **GitHub Actions Status:** [![CI](https://github.com/mehtadaksh6969/warden/actions/workflows/ci.yml/badge.svg)](https://github.com/mehtadaksh6969/warden/actions/workflows/ci.yml)
- **Run URL:** [GitHub Actions Workflow Runs](https://github.com/mehtadaksh6969/warden/actions)
...
![Warden UI Desktop Screenshot](media/test.png)

### Mobile & Responsive Layout (iPhone SE Layout)
![Warden UI Mobile responsive view](media/mobile-view.PNG)
...
- **Live URL:** [Warden Live Demo](https://warden-123.armed-flop-danger.workers.dev/)

---

## 11. Demo Video (1-2 min)

Here is a comprehensive 1-2 minute walkthrough of Warden demonstrating the deployment, wallet connection, selective disclosure authorization, and verifier check:
